  ...
  <style type="text/css">
   ...
   <form class="form-horizontal" action="" method="POST">
    ...
    <div class="input-group col-sm-6">
      <input type="text"  class="form-control input-lg" placeholder="masukkan kode pembayaran" name="kodebayar" >
      <span class="input-group-btn">
       <input type="submit" class="btn btn-lg btn-primary" name="cari" value="cari">
      </span>
    </div><!-- /input-group -->
